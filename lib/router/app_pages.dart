import 'package:GiliGili/pages/member/new/member_page.dart';
import 'package:GiliGili/pages/member/new/widget/edit_profile_page.dart';
import 'package:GiliGili/pages/setting/navigation_bar_set.dart';
import 'package:GiliGili/pages/setting/search_page.dart';
import 'package:GiliGili/pages/setting/sponsor_block_page.dart';
import 'package:GiliGili/pages/setting/view.dart';
import 'package:GiliGili/pages/tv_home/tv_home_page.dart';
import 'package:GiliGili/pages/video/detail/introduction/widgets/create_fav_page.dart';
import 'package:GiliGili/pages/video/detail/view_v.dart';
import 'package:GiliGili/pages/video/tv_player/tv_player_page.dart';
import 'package:GiliGili/pages/webview/webview_page.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:GiliGili/pages/msg_feed_top/at_me/view.dart';
import 'package:GiliGili/pages/msg_feed_top/reply_me/view.dart';
import 'package:GiliGili/pages/msg_feed_top/like_me/view.dart';
import 'package:GiliGili/pages/setting/pages/logs.dart';
...
class Routes {
  static final List<GetPage<dynamic>> getPages = [
    ...
    // TV首页
    CustomGetPage(name: '/tvHome', page: () => const TvHomePage()),
    // TV播放器
    CustomGetPage(name: '/tvPlayer', page: () => const TvPlayerPage()),
    // 热门
